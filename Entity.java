...
public abstract class Entity{
    ...
    public boolean isCollidingWith(Entity other){
            if ((other.x>this.x) & (other.x<this.x+this.width) & (other.y>this.y) & (other.y<this.y+this.height)){
                return true;
            }
            else if ((other.x+other.getWidth()>this.x) & (other.x+other.getWidth()<this.x+this.getWidth()) & (other.y+other.getHeight()>this.y) & (other.y+other.getHeight()<this.y+this.getHeight())){ //collides at top left of Player
                return true;
            }
            else if ((other.x>this.x) & (other.x<this.x+this.getWidth()) & (other.y+other.getHeight()>this.y) & (other.y+other.getHeight()<this.y+this.getHeight())){
                return true;
            }
            else if ((other.x+other.getWidth()>this.x) & (other.x+other.getWidth()<this.x+this.getWidth()) & (other.y>this.y) & (other.y<this.y+this.getHeight())){ //collides at bottom left of Player
                return true;
            }
            else{
                return false;
